  ...
  <div class="table">
    ...
    {#each evidenceList as evidence}
      <label class="control control-checkbox">
        <input type="checkbox" value={evidence.value} bind:group={selection.confirmed} on:change={(e) => { updateData(e, evidence.value, "confirmed") , emitData() }}/>
        <div class="control_indicator"></div>
      </label>
      <label class="control control-checkbox">
        <input type="checkbox" value={evidence.value} bind:group={selection.ruledOut} on:change={(e) => { updateData(e, evidence.value, "ruledOut"), emitData() }}/>
        <div class="control_indicator"></div>
      </label>
      <div>
